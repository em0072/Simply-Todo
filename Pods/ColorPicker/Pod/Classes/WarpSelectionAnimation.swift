...
class WarpSelectionAnimation: ColorPickerSelection {
    ...
    @objc func colorPicker(colorPicker: ColorPickerListView, changeFromIndex: Int, toIndex: Int) {
    ...
    @objc func colorPicker(colorPicker: ColorPickerListView, selectedAtIndex: Int) {
        self.colorPicker(colorPicker, selectedAtIndex: selectedAtIndex, ringView: selectedRingView)
    }
    
    @objc func colorPicker(colorPicker: ColorPickerListView, deselectAtIndex: Int) {
        self.colorPicker(colorPicker, deselectedAtIndex: deselectAtIndex, ringView: selectedRingView)
    }
    
    @objc func colorPickerPickerLayoutSubviews(colorPicker: ColorPickerListView) {
