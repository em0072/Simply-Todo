...
@objc public class ColorPickerListView: UIScrollView {
    ...
    public var colors = ["#FF7473", "#FFC952", "#47B8E0", "#79BD9A", "#87314E"] {
        didSet {
    ...
    @objc func colorAt(index: Int) -> String? {
        return  self.colorPickerButtons[index].pickerColor()
    }
    
    @objc func colorButtonAt(index: Int) -> ColorPickerButton {
   ...
   @objc private func configureView() {
    ...
    @objc public func selectColor(colorHex: String) {
   ...
   @objc func selectButtonAtIndex(index: Int) {
       let button = colorPickerButtons[index]
        selectColorButton(button)
    }
    
   @objc func selectColorButton(colorPickerButton: ColorPickerButton) {
